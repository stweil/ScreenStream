package info.dvkr.screenstream.vnc.ui.main.settings.common
...
@Composable
internal fun VncSettingModalTitle(
    title: String,
    onClose: () -> Unit
) {
    Row(
        ...
        IconButton(onClick = onClose) {
            Icon(
                ...
                contentDescription = stringResource(R.string.vnc_close)
            )
        }
    }
}
