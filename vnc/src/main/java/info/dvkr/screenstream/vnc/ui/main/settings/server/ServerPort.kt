...
internal fun ServerPortRow(
    ...
    SettingValueRow(
        ...
        title = stringResource(id = R.string.vnc_pref_server_port),
        summary = stringResource(id = R.string.vnc_pref_server_port_summary),
...
internal fun ServerPortEditor(
    ...
    SettingEditorLayout {
        Text(
            text = stringResource(id = R.string.vnc_pref_server_port_text),
